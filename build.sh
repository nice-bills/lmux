...
# Source files
SOURCES="main_gui.c vte_terminal.h browser.c notification.c socket_server.c workspace_commands.c terminal_commands.c focus_commands.c session_persistence.c lmux_css.c"
